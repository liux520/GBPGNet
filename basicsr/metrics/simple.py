...
def calculate_psnr_ssim(img1, img2, suffix, crop_border, test_y):
    '''
    https://github.com/greatlog/DAN/blob/master/metrics/calculate_PSNR_SSIM.py
    '''
    folder_GT = ''
    folder_Gen = ''
    ...
    for i, img_path in enumerate(img_list):
        ...
        im_Gen = cv2.imread(os.path.join(folder_Gen, f'{base}{suffix}{ext}')) / 255.
